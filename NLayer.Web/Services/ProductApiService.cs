...
namespace NLayer.Web.Services
{
    public class ProductApiService
    {
        ...
        {
            var response = await _httpClient.GetFromJsonAsync<CustomReponseDto<ProductDto>>($"products/{id}");
        ...
        {
            var response = await _httpClient.GetFromJsonAsync<CustomReponseDto<List<ProductWithCategoryDto>>>("products/GetProductsWithCategory");
        ...
        public async Task<ProductDto> SaveAsync(ProductDto newProduct)
        {
            ...
            var responseBody = await response.Content.ReadFromJsonAsync<CustomReponseDto<ProductDto>>();
